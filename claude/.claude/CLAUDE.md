...
頻出の禁止語: **発火**→発生、**窓**→ウィンドウ、**門**→ゲート、**床**→下限、**帯**→バンド／区域、
**旗**→フラグ、**錨**→アンカー、**粒度**→刻み。迷ったらオライリー日本語版が目安。

置換表の全体（16語）・残す語・検出規則・語彙の追加手順は
`~/dotfiles/claude/.claude/vocabulary-conventions.md` が正本。
